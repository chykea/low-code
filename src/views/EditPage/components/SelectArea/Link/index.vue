<template>
    <div :style="control.prop.boxStyle" @dragstart="dragStart" @drag="dragIn">
        <a :href="control.prop.href||'###'" :style="control.prop.style" @click.stop.prevent="isCheckedFunc"
            :class="[isChecked?'checked':'']">{{control.prop.text}}</a>
