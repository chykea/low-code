<template>
    <div :style="control.prop.boxStyle" @drag="dragIn" @dragstart="dragStart">
        <span :style="control.prop.style" :class="[isChecked?'SpanChecked':'','editspan']"
            @click.stop="isCheckedFunc">{{control.prop.text}}</span>
